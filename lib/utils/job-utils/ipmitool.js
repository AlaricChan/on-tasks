...
function ipmitoolFactory(Promise) {
    ...
    */
    ...
    Ipmitool.prototype.powerStatus = function(host, user, password) {
        return this.runCommand(host, user, password, "chassis power status");
    };
    ...
    /**
        * Returns a promise with the results or errors of invoking chassis power status
        *
        * @param host
        * @param user
        * @param password
        */
    Ipmitool.prototype.retrievePowerStatus = function(host, user, password) {
        return this.runCommand(host, user, password, "chassis power status");
    };
