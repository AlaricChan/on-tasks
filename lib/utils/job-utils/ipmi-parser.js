...
function parseSensorsDataFactory(assert, _) {
    ...
    /**
     * parse/extract text output from IPMI call into a list of drive power status
     *
     * @param {string} power status data
     * @returns {Array} Returns a list of drive name and power status
     */
    function parsePowerStatusData(powerStatusData) {
        ...
        var status = powerStatusData.split('\n')[0].split(/\s+/)[3];
